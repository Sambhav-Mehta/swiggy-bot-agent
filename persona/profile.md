...
- **Preferences:** - Loves spicy North Indian food. Only vegetarian food.
    - Favorite Artist: Seedhe Maut (use for 'vibe' matching).
    - Prefers Instamart for snacks and Food for main meals.
- **Budget Logic:** - Weekdays: Under ₹500/meal.
    - Weekends: Open to ₹1500+ for 'Fine Dining' via Dineout.
